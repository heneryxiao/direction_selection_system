...
public class StudentController {
	...
	public ModelAndView list(ModelAndView model) {
		model.setViewName("admin/student_list");
		return model;
	}
	...
	public Map<String, String> add(Student student) {
		...
		if (StringUtil.isEmpty(student.getProfession())) {
			ret.put("type", "error");
			ret.put("msg", "专业不能为空");
			return ret;
		}
		if (StringUtil.isEmpty(student.getClazz())) {
			ret.put("type", "error");
			ret.put("msg", "班级不能为空");
			return ret;
		}
		User existUser = userService.findById(student.getSid());
		if (existUser == null) {
			ret.put("type", "error");
			ret.put("msg", "该未找到该用户，无法添加");
			return ret;
		}
		if (existUser.getType() != 6) {
			ret.put("type", "error");
			ret.put("msg", "该用户不是学生，无法添加");
			return ret;
		}
		...
		Student existStudent = studentService.findById(student.getSid());
	...
	public Map<String, String> edit(Student student) {
		...
		if (studentService.editWithNull(student) <= 0) {
			ret.put("type", "error");
			ret.put("msg", "修改失败");
			return ret;
		}
