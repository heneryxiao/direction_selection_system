        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'tid', title: '用户名', sortable: true, width: 80},
                    {field: 'name', title: '姓名', width: 80},
                    {field: 'gender', title: '性别', width: 50},
                    {field: 'email', title: '邮箱', width: 150},
                    {field: 'introduce', title: '老师简介', width: 400},
                ]],
                toolbar: "#toolbar"
            });
            //设置分页控件
            ...
            $("#search-btn").click(function () {
                $('#dataList').datagrid('reload', {
                    tid: $("#search-username").searchbox('getValue')
                });
...
<div id="addDialog" style="padding: 10px;">
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="6">
            <tr>
                <td>用户名 :</td>
                <td><input id="add_tid" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="tid" data-options="required:true, validType:'repeat', missingMessage:'请填写用户名'"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
