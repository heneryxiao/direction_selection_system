    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#search-btn").click(function () {
                $('#dataList').datagrid('reload', {
                    cid: $("#search-username").searchbox('getValue')
                });
...
<div id="addDialog" style="padding: 10px;">
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="6">
            <tr>
                <td>用户名 :</td>
                <td><input id="add_cid" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="cid" data-options="required:true, validType:'repeat', missingMessage:'请填写用户名'"/></td>
            </tr>
            <tr>
                <td>姓名:</td>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        ...
        <table id="editTable" border=0 cellpadding="8">
            ...
            <tr>
                <td>授课老师ID:</td>
                <td><input id="edit_tid" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="tid" data-options="required:true, missingMessage:'请填写授课老师ID'"/></td>
            </tr>
            <tr>
                <td>授课课程ID:</td>
                <td><input id="edit_courseid" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="courseid" data-options="required:true, missingMessage:'请填写授课课程ID'"/></td>
            </tr>
        </table>
    </form>
