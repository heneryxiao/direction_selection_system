...
<div class="container">
		<div class="row">
			...
			<h5>修改对应授课课程（填写ID）</h5>
			<form
			action="../SelfInformation/ModiCourseid"
			method="get">
			<div class="row">
			
				<div class="col-md-3"><input type="text" name="courseid" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"/> </div>
