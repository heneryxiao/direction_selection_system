    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            <tr>
                <td>方向ID:</td>
                <td>
                    <input id="add_branchId" class="easyui-textbox" style="width: 200px; height: 30px;" type="text"
                           name="branchid" data-options="required:true, missingMessage:'请填写方向ID'"/>
                </td>
            </tr>
            <tr>
                <td>方向名称:</td>
                <td><input id="add_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="name" data-options="required:true, missingMessage:'请填写方向名称'"/></td>
            </tr>
            <tr>
                <td>限选人数:</td>
                <td><input id="add_limited" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="limited" data-options="required:true, missingMessage:'请填写限制人数'"/></td>
            </tr>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        ...
        <table id="editTable" border=0 cellpadding="8">
            ...
            <tr>
                <td>限选人数:</td>
                <td><input id="edit_limited" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           name="limited" data-options="required:true, missingMessage:'请填写限制人数'"/></td>
            </tr>
        </table>
    </form>
