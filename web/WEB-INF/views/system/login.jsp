...
<head>
        ...
        $(function () {
            ...
            $("#submitBtn").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "login",
                    data: data, //Controller中返回的数据(map)
    ...
    <title>登录|学生专业方向选择系统</title>
    <meta name="keywords" content="学生专业方向选择系统">
</head>
<body>
...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post">
            ...
            <%-- <label for="radio-3">管理员</label> 其中改成了radio-2
                学生，管理员选项
             --%>
            <%--
...
<div class="footer">Copyright &nbsp; 肖智海 @ 【Henery】</div>
